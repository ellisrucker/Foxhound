...
public class Case {
    ...
    //Stores hashed representation of Entities.Case's last row
    private ArrayList<Integer> caseState = new ArrayList<>();

    //Record of each time Entities.Case is updated, use in Update's constructor!
    ...
    public boolean equals(Object o){
        ...
        //Typecast Object down to a Entities.Case
        Case c = (Case) o;
